...
<div class="p-4 space-y-4">
    ...
    <div class="bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 rounded-2xl p-5 text-white shadow-xl">
        <div class="text-center">
            ...
            <p class="text-primary-200 text-sm mt-2">≈ ${{ number_format(($wallet->main_balance ?? 0) / ($usdtRate ?? 120), 2) }} USDT</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" id="fromAmount" value="{{ $wallet->main_balance ?? 0 }}" 
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" id="toAmount" value="{{ number_format(($wallet->main_balance ?? 0) / ($usdtRate ?? 120), 2, '.', '') }}" 
        ...
        <div class="mt-4 p-3 bg-blue-50 rounded-xl">
            <div class="flex items-center justify-between text-sm">
                ...
                <span class="font-semibold text-blue-700">1 USDT = ৳<span id="currentRate">{{ number_format($usdtRate ?? 120, 2) }}</span></span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <div class="grid grid-cols-3 gap-2">
            @foreach([100, 500, 1000, 2000, 5000, 10000] as $amount)
                <button onclick="setAmount({{ $amount }})" class="py-2 px-3 bg-gray-100 hover:bg-primary-100 hover:text-primary-600 rounded-lg text-sm font-medium transition-colors">
        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between p-3 bg-yellow-50 rounded-xl">
                ...
                <div class="text-right">
                    <p class="font-bold text-gray-900">৳{{ number_format($usdtRate ?? 120, 2) }}</p>
