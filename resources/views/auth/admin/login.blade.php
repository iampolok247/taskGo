...
<div class="min-h-screen flex flex-col justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-4 py-8 safe-area-top safe-area-bottom">
    <div class="w-full max-w-md mx-auto">
        ...
        <div class="flex items-center gap-2 mb-4 px-1">
            ...
            <span class="text-xs font-medium text-gray-700 uppercase tracking-wide">Admin Login</span>
        </div>
            ...
            <form method="POST" action="{{ route('admin.login') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                            class="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-gray-800 focus:ring-2 focus:ring-gray-800/20 outline-none transition-all bg-slate-50 focus:bg-white"
                            placeholder="admin@taskgo.live">
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded border-gray-300 text-gray-800 focus:ring-gray-800">
                        <span class="text-sm text-gray-600">Remember me</span>
                    </label>
                </div>

                <button type="submit" class="w-full py-3 px-4 bg-gray-800 hover:bg-gray-900 text-white font-semibold rounded-xl transition-all shadow-lg shadow-gray-800/25 active:scale-[0.98] flex items-center justify-center gap-2">
