    ...
    <div class="w-full max-w-md mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-1.5 mb-4">
            <div class="grid grid-cols-3 gap-1">
                <a href="{{ route('login') }}"
                   class="flex flex-col items-center gap-1 py-3 px-2 rounded-xl bg-primary-500 text-white shadow-md shadow-primary-500/30 transition-all">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                            class="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none transition-all bg-slate-50 focus:bg-white"
                ...
                <button type="submit" class="w-full py-3 px-4 bg-primary-500 hover:bg-primary-600 text-white font-semibold rounded-xl transition-all shadow-lg shadow-primary-500/25 active:scale-[0.98] flex items-center justify-center gap-2">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-500">
                    ...
                    <a href="{{ route('register') }}" class="text-primary-500 font-semibold hover:underline">Create Account</a>
                </p>
            </div>
        </div>
