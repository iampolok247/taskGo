...
<div class="p-4 space-y-4">
    <div class="bg-white rounded-xl p-6 shadow-sm">
        ...
        <form method="POST" action="<?php echo e(route('user.profile.password.update')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/taskisfk/public_html/resources/views/user/profile/password.blade.php ENDPATH**/ ?>