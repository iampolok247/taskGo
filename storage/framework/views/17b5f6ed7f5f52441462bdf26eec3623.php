...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white">
        <h1 class="text-2xl font-bold mb-2">Welcome back, <?php echo e(auth('agent')->user()->name); ?>!</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-xl p-5 shadow-sm">
            ...
            <p class="text-xs text-gray-500 mt-2"><?php echo e($stats['active_users']); ?> active this month</p>
        </div>
        ...
        <div class="bg-white rounded-xl p-5 shadow-sm">
            ...
            <p class="text-xs text-gray-500 mt-2">৳<?php echo e(number_format($stats['pending_commission'], 2)); ?> pending</p>
        </div>
        ...
        <div class="bg-white rounded-xl p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">৳<?php echo e(number_format($stats['month_commission'], 2)); ?></p>
                </div>
            ...
            <p class="text-xs text-gray-500 mt-2"><?php echo e($stats['month_users']); ?> new users</p>
        </div>
        ...
        <div class="bg-white rounded-xl p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($agent->commission_rate); ?>%</p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <a href="<?php echo e(route('agent.users.create')); ?>" class="bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow flex items-center gap-4">
        ...
        <a href="<?php echo e(route('agent.users.index')); ?>" class="bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow flex items-center gap-4">
        ...
        <div class="bg-white rounded-xl shadow-sm">
            <div class="p-4 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('agent.users.index')); ?>" class="text-sm text-emerald-600 font-medium">View All</a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm">
            <div class="p-4 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('agent.commissions.index')); ?>" class="text-sm text-emerald-600 font-medium">View All</a>
                </div>
            </div>
            <div class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $recentCommissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center
                            <?php if($commission->status == 'paid'): ?> bg-green-100 <?php else: ?> bg-yellow-100 <?php endif; ?>">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900"><?php echo e($commission->user->name ?? 'Unknown'); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e(ucfirst($commission->type)); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-sm font-semibold text-green-600">+৳<?php echo e(number_format($commission->amount, 2)); ?></p>
                            <span class="text-xs px-2 py-0.5 rounded-full
                                <?php if($commission->status == 'paid'): ?> bg-green-100 text-green-700
...
<?php echo $__env->make('layouts.agent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/taskisfk/public_html/resources/views/agent/dashboard.blade.php ENDPATH**/ ?>