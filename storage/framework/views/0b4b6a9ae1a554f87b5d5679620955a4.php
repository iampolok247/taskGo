    ...
    <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-5 text-white shadow-lg">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <h2 class="text-3xl font-bold">৳<?php echo e(number_format($totalEarnings, 2)); ?></h2>
            </div>
        ...
        <div class="flex items-center gap-4 text-sm">
            <div>
                ...
                <p class="font-semibold text-xl"><?php echo e($totalReferrals); ?></p>
            </div>
            <div class="w-px h-8 bg-white/20"></div>
            <div>
                <p class="text-purple-200">Active Users</p>
                <p class="font-semibold text-xl"><?php echo e($activeReferrals); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm">
        ...
        <div class="bg-gray-50 rounded-xl p-4 mb-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-primary-500"><?php echo e($user->referral_code); ?></p>
                </div>
        ...
        <div class="bg-gray-50 rounded-xl p-4">
            ...
            <div class="flex items-center gap-2">
                <input type="text" readonly value="<?php echo e($referralLink); ?>" class="flex-1 px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-600">
        ...
        <div class="mt-4">
            ...
            <div class="flex gap-3">
                <a href="https://wa.me/?text=<?php echo e(urlencode('Join Task Go and start earning! Use my referral code: ' . $user->referral_code . ' ' . $referralLink)); ?>" 
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode($referralLink)); ?>" 
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm">
        ...
        <div class="space-y-3">
            <div class="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                ...
                <p class="font-bold text-green-600">৳<?php echo e(number_format($signupBonus, 2)); ?></p>
            </div>
            <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-500">Earn <?php echo e($taskCommissionPercent); ?>% of their task earnings</p>
                </div>
                <p class="font-bold text-blue-600"><?php echo e($taskCommissionPercent); ?>%</p>
            </div>
        </div>
    </div>
                ...
                <?php $__currentLoopData = $referrals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $referral): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 flex items-center gap-3">
                        <div class="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                            <span class="text-purple-600 font-bold text-sm"><?php echo e(strtoupper(substr($referral->referredUser->name ?? 'U', 0, 2))); ?></span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900"><?php echo e($referral->referredUser->name ?? 'Unknown User'); ?></p>
                            <p class="text-xs text-gray-500">Joined <?php echo e($referral->created_at->format('M d, Y')); ?></p>
                        </div>
                        <div class="text-right">
                            ...
                            <?php endif; ?>
                            <p class="text-xs text-gray-500 mt-1">৳<?php echo e(number_format($referral->total_earned, 2)); ?> earned</p>
                        </div>
                    </div>
...
<script>
function copyCode() {
    const code = '<?php echo e($user->referral_code); ?>';
...
function copyLink() {
    const link = '<?php echo e($referralLink); ?>';
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/taskisfk/public_html/resources/views/user/referrals/index.blade.php ENDPATH**/ ?>