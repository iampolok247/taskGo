<?php $__env->startSection('title', 'Currency Rates'); ?>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="font-mono font-medium text-gray-900"><?php echo e($rate->from_currency); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="font-mono font-medium text-gray-900"><?php echo e($rate->to_currency); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="font-medium text-green-600"><?php echo e(number_format($rate->rate, 4)); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-gray-900"><?php echo e($rate->fee_percentage); ?>%</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex px-2 py-1 text-xs font-medium rounded-full <?php echo e($rate->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'); ?>">
                                <?php echo e($rate->is_active ? 'Active' : 'Inactive'); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($rate->updated_at->diffForHumans()); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button onclick="editRate('<?php echo e($rate->from_currency); ?>', '<?php echo e($rate->to_currency); ?>', <?php echo e($rate->rate); ?>, <?php echo e($rate->fee_percentage); ?>, <?php echo e($rate->is_active ? 'true' : 'false'); ?>)" class="text-primary-600 hover:text-primary-900">
                                Edit
                            </button>
                        </td>
                    </tr>
...
<div id="addRateModal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl w-full max-w-md">
        ...
        <form action="<?php echo e(route('admin.settings.currency-rates.update')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/taskisfk/public_html/resources/views/admin/settings/currency-rates.blade.php ENDPATH**/ ?>