        ...
        <div class="bg-white rounded-2xl shadow-xl p-6">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="referral_code" name="referral_code" value="<?php echo e(old('referral_code', $referralCode ?? '')); ?>"
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none transition-all"
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-primary-500 font-medium hover:underline">Sign In</a>
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/taskisfk/public_html/resources/views/auth/user/register.blade.php ENDPATH**/ ?>