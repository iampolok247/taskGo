...
<body class="bg-gray-50">
        ...
        <nav class="container mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('login')); ?>" class="text-white hover:text-purple-200 transition">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-purple-600 px-6 py-2 rounded-full font-semibold hover:bg-purple-100 transition">
                        Get Started
                    </a>
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row items-center">
                <div class="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="<?php echo e(route('register')); ?>" class="bg-yellow-400 text-purple-900 px-8 py-4 rounded-full font-bold text-lg hover:bg-yellow-300 transition transform hover:scale-105 shadow-lg">
    ...
    <section class="py-20 gradient-bg">
        <div class="container mx-auto px-4 text-center">
            ...
            <a href="<?php echo e(route('register')); ?>" class="inline-block bg-yellow-400 text-purple-900 px-10 py-4 rounded-full font-bold text-lg hover:bg-yellow-300 transition transform hover:scale-105 shadow-lg">
    ...
    <footer class="bg-gray-900 text-gray-400 py-12">
        <div class="container mx-auto px-4">
            ...
            <div class="border-t border-gray-800 pt-8 text-center text-sm">
                <p>© <?php echo e(date('Y')); ?> Task Go. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
</html>
<?php /**PATH /home/taskisfk/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>