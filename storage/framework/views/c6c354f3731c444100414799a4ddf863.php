...
<div class="p-4 space-y-4">
        ...
        <div class="relative z-10">
            ...
            <div class="grid grid-cols-3 gap-3 mt-4">
                <div class="bg-white/10 rounded-xl p-3 backdrop-blur-sm">
                    ...
                    <p class="font-bold text-lg mt-1">৳<?php echo e(number_format($wallet->pending_balance ?? 0, 2)); ?></p>
                </div>
                <div class="bg-white/10 rounded-xl p-3 backdrop-blur-sm">
                    <p class="text-primary-200 text-[10px] uppercase tracking-wide">💸 Withdrawable</p>
                    <p class="font-bold text-lg mt-1">৳<?php echo e(number_format($wallet->main_balance ?? 0, 2)); ?></p>
                </div>
                <div class="bg-white/10 rounded-xl p-3 backdrop-blur-sm">
                    <p class="text-primary-200 text-[10px] uppercase tracking-wide">🎁 Bonus</p>
                    <p class="font-bold text-lg mt-1">৳<?php echo e(number_format($wallet->bonus_balance ?? 0, 2)); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-3">
        <a href="<?php echo e(route('user.deposits.create')); ?>" class="flex items-center gap-3 p-4 bg-white rounded-2xl shadow-sm border border-gray-100 active:scale-95 transition-transform">
        ...
        <a href="<?php echo e(route('user.withdrawals.create')); ?>" class="flex items-center gap-3 p-4 bg-white rounded-2xl shadow-sm border border-gray-100 active:scale-95 transition-transform">
    ...
    <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
        <div class="flex items-center justify-between mb-3">
            ...
            <a href="<?php echo e(route('user.wallet.convert')); ?>" class="text-sm text-primary-500 font-medium">Convert →</a>
        </div>
        <div class="grid grid-cols-3 gap-3">
            <div class="bg-gray-50 rounded-xl p-3 text-center">
                <p class="text-xs text-gray-500">BDT</p>
                <p class="font-bold text-gray-900">৳<?php echo e(number_format($wallet->main_balance ?? 0, 0)); ?></p>
            </div>
            ...
            <div class="bg-yellow-50 rounded-xl p-3 text-center">
                ...
                <p class="font-bold text-yellow-600">$<?php echo e(number_format(($wallet->main_balance ?? 0) / ($usdtRate ?? 120), 2)); ?></p>
            </div>
        </div>
        <p class="text-xs text-gray-400 text-center mt-2">Rate: $1 = ৳<?php echo e(number_format($usdtRate ?? 120, 2)); ?></p>
    </div>
        ...
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-900">৳<?php echo e(number_format($totalDeposits ?? 0, 0)); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-900">৳<?php echo e(number_format($totalWithdrawals ?? 0, 0)); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-4 text-white shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-bold mt-1">৳<?php echo e(number_format($wallet->total_earned ?? 0, 2)); ?></h3>
            </div>
    ...
    <div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 divide-y divide-gray-100">
                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl flex items-center justify-center <?php echo e($transaction->amount > 0 ? 'bg-green-100' : 'bg-red-100'); ?>">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500"><?php echo e($transaction->created_at->format('M d, Y h:i A')); ?></p>
                        </div>
        ...
        <?php else: ?>
            <div class="bg-white rounded-2xl p-8 text-center shadow-sm border border-gray-100">
                ...
                <a href="<?php echo e(route('user.tasks.index')); ?>" class="inline-block mt-4 px-6 py-2 bg-primary-500 text-white rounded-xl font-medium text-sm hover:bg-primary-600 transition-colors">
                    Browse Tasks
                </a>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/taskisfk/public_html/resources/views/user/wallet/index.blade.php ENDPATH**/ ?>