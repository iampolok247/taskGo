...
<div class="space-y-6 max-w-2xl">
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <form action="<?php echo e(route('admin.announcements.update', $announcement)); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                    placeholder="Write your announcement message..."><?php echo e(old('content', $announcement->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="type" required class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        ...
                        <option value="warning" <?php echo e($announcement->type === 'warning' ? 'selected' : ''); ?>>Warning</option>
                        <option value="promo" <?php echo e($announcement->type === 'promo' ? 'selected' : ''); ?>>Promo</option>
                        <option value="update" <?php echo e($announcement->type === 'update' ? 'selected' : ''); ?>>Update</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="target" required class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        <option value="all" <?php echo e($announcement->target === 'all' ? 'selected' : ''); ?>>All (Users & Agents)</option>
                        <option value="users" <?php echo e($announcement->target === 'users' ? 'selected' : ''); ?>>Users Only</option>
                        <option value="agents" <?php echo e($announcement->target === 'agents' ? 'selected' : ''); ?>>Agents Only</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="datetime-local" name="starts_at" value="<?php echo e(old('starts_at', $announcement->starts_at?->format('Y-m-d\TH:i'))); ?>" 
                ...
                <div>
                    ...
                    <input type="datetime-local" name="ends_at" value="<?php echo e(old('ends_at', $announcement->ends_at?->format('Y-m-d\TH:i'))); ?>" 
                        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                </div>
            </div>
            ...
            <div class="flex items-center gap-6">
                ...
                <label class="flex items-center gap-2">
                    <input type="checkbox" name="is_pinned" value="1" <?php echo e($announcement->is_pinned ? 'checked' : ''); ?> 
                        class="w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/taskisfk/public_html/resources/views/admin/announcements/edit.blade.php ENDPATH**/ ?>